...
pub fn OverviewCardGrid(
    ...
    prefix: PrefixCacheMetricsSnapshot,
    ...
    // Fix Bug 2: Use ops data (from admin profile enrichment) instead of health probe data.
    ...
    let suggestions_qps = suggestions.clone();
